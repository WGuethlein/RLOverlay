...
const TeamName = (props) => {
  ...
  if (props.id == "left") {
    return (
      <>
        <div
          className={`${styles.teamName} ${styles.left}`}
          contentEditable="true"
          onBlur={(e) => setLeftTeam(e.currentTarget.textContent)}
          suppressContentEditableWarning={true}
        >
          {localStorage.getItem("leftTeam")}
        </div>
      </>
    );
  } else {
    return (
      <>
        <div
          className={`${styles.teamName} ${styles.right}`}
          contentEditable="true"
          onBlur={(e) => setRightTeam(e.currentTarget.textContent)}
          suppressContentEditableWarning={true}
        >
          {localStorage.getItem("rightTeam")}
        </div>
      </>
    );
  }
